...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public static final String KEY_P_SKILL_LEVEL = "skill_level";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVer, int newVer){
        ...
        String replace_table_friends = "DROP TABLE IF EXISTS "+ TABLE_NAME_FRIENDS;
        db.execSQL(replace_table_friends);
        onCreate(db);
    }
